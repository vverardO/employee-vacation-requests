                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                @if($user->status == 0)
                                    <a type="button" rel="tooltip" wire:click="grantAccess({{$user->id}})" class="text-success" title="Ativar">
                                        <i class="fas fa-user-check"></i>
                                    </a>
                                @else
                                    <a type="button" rel="tooltip" wire:click="revokeAccess({{$user->id}})" class="text-danger" title="Inativar">
                        ...
                        @empty
                        <tr>
                            <td colspan="6" align="center">Nenhuma informação a ser apresentada</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
